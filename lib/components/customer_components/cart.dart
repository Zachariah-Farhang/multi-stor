                                                                    ...
                                                                    showCupertinoModalPopup<
                                                                      ...
                                                                      builder: (BuildContext
                                                                        ...
                                                                        title: const Text(
                                                                            'حدف آیتم'),
                                                                        message:
                                                                            const Text('آیا مطمعین هستید که میخواهید این آیتم رو حذف کنید؟'),
                                                                        actions: <CupertinoActionSheetAction>[
                                                                          CupertinoActionSheetAction(
                                                                              child: const Text('انتقال به علاقه مندی ها'),
                                                                              onPressed: () {
                                                                                if (context.read<Wish>().getWishItem.firstWhereOrNull((element) => element.productId == product.productId) != null) {
                                                                                  context.read<Cart>().removeItem(product);
                                                                                  Navigator.pop(context);
                                                                                } else {
                                                                                  context.read<Wish>().addToWishItem(product.name, product.price, 1, product.qntty, product.imageUrl, product.productId, product.suppId);
